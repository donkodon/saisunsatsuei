      ...
      if (path === "/api/products/items" && request.method === "POST") {
        ...
        await env.DB.prepare(`
          INSERT INTO product_items (
            ...
            price, price_sale,
            condition, material, product_rank, description, inspection_notes,
            image_urls, actual_measurements, 
        ...
        `).bind(
          ...
          data.size || null,
          data.color || null,
          data.price || data.priceSale || null,
          data.priceSale || null,
          data.condition || null,
          data.material || null,
        ...
        if (data.name || data.category || data.brand || data.size || data.color || data.priceSale || data.brandKana || data.categorySub || data.priceCost || data.season || data.releaseDate || data.buyer || data.storeName || data.priceRef || data.priceList || data.location || data.stockQuantity || data.barcode) {
          await env.DB.prepare(`
...
// .wrangler/tmp/bundle-RtXaMd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RtXaMd/middleware-loader.entry.ts
